...
> v0.5.9 Beta · Default server profile: **FusionFall Retrobution**
...
The source used to build v0.5.9 Beta and future APKs is visible directly in this repository.

## Server profiles

v0.5.9 Beta keeps **FusionFall Retrobution** as the ready-to-use default profile and adds an

...
OpenFusion Android v0.5.8 Beta includes two profile types:
...
The v0.5.8 login screen also uses these standard OpenFusion launcher endpoints when available:

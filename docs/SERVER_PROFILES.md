...
OpenFusion Android v0.5.9 Beta includes two profile types:
...
The v0.5.9 login screen also uses these standard OpenFusion launcher endpoints when available:

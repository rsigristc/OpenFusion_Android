...
/** v0.5.5 Beta bounded, privacy-conscious diagnostics for the Android compatibility layer. */
public final class FusionFallDiagnostics {
    ...
    public static void export(Activity activity) {
        ...
        new Thread(() -> {
            try {
                ...
                File file = new File(directory, "OpenFusion-Android-v0.5.5-beta-" + stamp + ".txt");
    ...
    private static void shareFile(Activity activity, File file) {
        try {
            ...
            send.putExtra(Intent.EXTRA_SUBJECT, "OpenFusion Android v0.5.5 Beta diagnostics");
